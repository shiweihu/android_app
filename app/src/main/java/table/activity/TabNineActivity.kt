...
class TabNineActivity : Activity() {
    ...
    override fun onStart() {
        ...
        val TabNine = myApp.menuListL?.get(8) as menuItem
        var tip = TabNine?.tips
        var content = TabNine?.content
        var title = TabNine?.title
        title = title?.replace("\n", "")
        ...
        listView.adapter =ListItemAdapt(this,TabNine)
